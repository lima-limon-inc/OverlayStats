...
src_compile() {
	cargo_src_compile --features "$(usex cranelift backend-cranelift "") $(usex llvm backend-llvm "") $(usex singlepass backend-singlepass "") wasi" --bin wasmer
	# kwasmd / loader-kernel seems to depend on backend-singlepass, disabled
}

src_install() {
	cargo_src_install --features "$(usex cranelift backend-cranelift "") $(usex llvm backend-llvm "") $(usex singlepass backend-singlepass "") wasi" --bin wasmer
	einstalldocs
}
