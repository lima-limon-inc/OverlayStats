...
HOMEPAGE="https://github.com/kelaresg/go-skype-bridge"

LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="~amd64"
#TODO: a use flag for end-to-end encryption / dependence on libolm.
IUSE=""
...
EGO_SUM=(
    ...
    "github.com/gogf/gf v1.13.0/go.mod"
    ...
    "github.com/gqcn/structs v1.1.1/go.mod"
    "github.com/grokify/html-strip-tags-go v0.0.0-20190921062105-daaa06bf1aaf"
    "github.com/grokify/html-strip-tags-go v0.0.0-20190921062105-daaa06bf1aaf/go.mod"
    ...
    "github.com/kelaresg/go-skypeapi v0.1.2-0.20210813144457-5bc29092a74e/go.mod"
    ...
    "github.com/pidongqianqian/mautrix-go v0.10.4-0.20211208080648-321c4f849adb"
    "github.com/pidongqianqian/mautrix-go v0.10.4-0.20211208080648-321c4f849adb/go.mod"
...
EGIT_REPO_URI="https://github.com/OttoHollmann/go-skype-bridge.git"
EGIT_COMMIT="4d5e43a03977cd3256af097a073b06d2e654dbc5"
# 	EGIT_REPO_URI="https://github.com/kelaresg/go-skype-bridge"
# 	EGIT_COMMIT="2d03904646865eca07c309b3b81d4c3510c84436"
SRC_URI="${EGO_SUM_SRC_URI}"
GO_IMPORTPATH="github.com/kelaresg/go-skype-bridge"
EGO_PN="${GO_IMPORTPATH}"
...
src_compile() {
	...
	env GOPATH="${OUT_GOPATH}":/usr/lib/go-gentoo CGO_CFLAGS="${CGO_CFLAGS} -Wno-return-local-addr" GOCACHE="${T}"/go-cache go build -trimpath -v -x -p 1 -work "${S}" || die "Exit code $?"
}

src_test() {
	env GOPATH="${OUT_GOPATH}":/usr/lib/go-gentoo CGO_CFLAGS="${CGO_CFLAGS} -Wno-return-local-addr" GOCACHE="${T}"/go-cache go test -trimpath -v -x -p 1 -work "${S}" || die
}
