...
src_compile() {
	...
	## mono related adjustments
	if use mono; then
		## workaround sandbox violation because JoyDev tries to access /dev/input/*
		sed 's/\/dev\/input/\/tmp\/input/g' ./bin/godot.linuxbsd.editor.x86_64.main.mono > ./bin/godot.linuxbsd.editor.x86_64.main.mono-noInput
		chmod +x ./bin/godot.linuxbsd.editor.x86_64.main.mono-noInput
		./bin/godot.linuxbsd.editor.x86_64.main.mono-noInput --headless --generate-mono-glue ./modules/mono/glue
